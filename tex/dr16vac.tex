...
prior that represent the population of binaries.
...
modes of the posterior pdf can be vastly different depending on the precision of
the data, number of data points, and phase coverage.
...
samplings are not dense enough to fully capture the support of the posterior pdf
and its detailed multi-modal structure.
