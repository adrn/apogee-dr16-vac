...
\title{Binary companions to APOGEE DR16 stars: \\
       Catalog of $\sim$20,000 binary star systems and constraints on the
...
% Binary star systems provide key context and constraints for nearly all subfields in astrophysics, yet
% Precise inferences about binary star populations --- which provide key context
% for all subfields of astrophysics --- typically rely on just hundreds of stars
% nearest to the sun.

\begin{abstract}
% Context
Most present challenges in astrophysics, from understanding the formation and
occurrence rates of stellar-mass black holes to untangling the chemical
...
on the posterior samplings ... using a likelihood ratio...
As a demonstration, we ...
We also find interesting low-mass and high-mass systems...
% Conclusions
...
A better understanding the population of binary stars throughout our galaxy is
important for all aspects of astrophysics.
For example, ... stellar-mass binary black hole mergers to stellar populations
in high-redshift galaxies \citep[e.g.,][]{Breivik:BAAS, Rix:BAAS}.

We need to understand the population statistics of stellar multiplicity and
their variations with stellar type, chemistry, and dynamical environment.

This problem spans a wide range of timescales, wavelengths, and many current and
near-future stellar surveys (Gaia, APOGEE, LAMOST, SDSS-V, etc.) have the
