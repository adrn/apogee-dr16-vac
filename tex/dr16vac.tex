...
are now many main-sequence stars too).
Because of operational re-visit decisions, the surveys deliver some
...
performs brute-force rejection sampling from a prior sampling.
...
on the confidence of the characterization; that is, this project deliberately conflates
...
In what follows, we run \thejoker\ on all of \apogee\ \dr{16}
...
- Like: \citep{Duquennoy:1991, Raghavan:2010}
...
% Lars: "Any idea of the incidence of stars which did an engulfment on their way
% UP the RGB from the Luminosity of the clump to that of the RGB TIP? "
