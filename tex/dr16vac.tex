...
\begin{figure}[!t]
    ...
    \end{center}
    \caption{%
    Example binary star systems from the \goldsample\ with faint, high-mass
    companions that are candidate compact objects.
    \todo{words...}
...
- Binary fraction trends with metallicity:
    - Dark matter masses of dwarfs!
    - X-ray binaries in globulars: maybe just because of metallicity?
    - More compact object mergers in halo?
- Some appreciable fraction of giant stars merge with companions - do these
stars move to other places in the CMD?
    - Bias stellar mass inferences for old stellar populations using SSP models
