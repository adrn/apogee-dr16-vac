...
characterization of binary systems using the radial-velocity method, in the
...
These samplings can be used to perform hierarchical inferences about binary-star
...
threshold and therefore can be used for myriad statistical inferences, including
