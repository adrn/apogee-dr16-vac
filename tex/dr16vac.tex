...
in astrophysics.
For example, the occurrence rate of stellar-mass black holes directly XX binary
black hole mergers observed by \acronym{LIGO} \citep{LIGO}, and interpreting
spectroscopic observations of high-redshift galaxies requires XX stellar populations
\citep[see][ for more motivation]{Breivik:BAAS, Rix:BAAS}.
A critical goal ... to understand the population properties of stellar
multiplets and their variations with stellar type, chemistry, and dynamical
environment.
...
solar neighborhood (Raghavan) or with imprecise statistics using large samples
of stars (Badenes).
We now have the sample sizes and tools needed to perform hierarchical inferences
to constrain much more detailed models of binary star formation and evolution.
...
[two sentences about APOGEE and compare to other surveys]
