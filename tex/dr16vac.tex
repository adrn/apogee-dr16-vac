...
but the survey uses fiber-plugged plates that cover only a small fraction of the
by area, which leads to extremely nonuniform coverage of the Galactic stellar
distribution (see, e.g., Figure~1 in \citealt{DR16}).
...
combined before the \apogee\ data reduction pipeline \citep{ASPCAP} determines
